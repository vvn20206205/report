...
\begin{example} Trong đồ án này, mô hình miền của em bao gồm \emph{"Yêu cầu nghiệp vụ"}, các sơ đồ trong phần \emph{"Phân tích sơ đồ Use Case"} và các sơ đồ mẫu kỹ thuật ở phần \emph{"Các mẫu kỹ thuật trong thiết kế hướng miền"}. \end{example}
