              ...
              \item Quản lý khách hàng
                    ...
                    \begin{vmatrix}
                        ...
                        \begin{itemize}
                            ...
                            \item Mã số thuế: có 10 ký tự đại diện cá nhân, doanh nghiệp hoặc 14 ký tự đại diện chi nhánh của doanh nghiệp với định dạng "Mã số thuế doanh nghiệp-Mã chi nhánh". % # Code
              ...
              \item Quản lý ký hiệu hóa đơn
                    ...
                    \begin{vmatrix}
                        ...
                        \begin{itemize}
                            ...
                            \item Loại hóa đơn % # Code

                            \item Ký hiệu hóa đơn % # Code
